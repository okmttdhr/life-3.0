...
そして、この本のタイトルにもなっている`life`について、3つのステージを定義している。それが、`Life 1.0` `Life 2.0` `Life 3.0`である。詳細な説明は省くが、それぞれ以下のように分類できる。

- Life 1.0 (biological stage): 上記で定義した`life`を満たすが、シンプルなアルゴリズムによって生存するもの(バクテリアなど)
- Life 2.0 (cultural stage): `Life 1.0`に加え、ハードウェア、ソフトウェア共に発達したもの(人間)
- Life 3.0 (technological stage): ハードウェアもソフトウェアも自在にデザインできるもの(AI?)
