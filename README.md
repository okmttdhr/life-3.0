...
そのため、例えば、教師、看護師、医師、学者、起業家、プログラマー、エンジニア、弁護士、ソーシャルワーカー、僧侶、芸術家、美容師、マッサージセラピスト、などが **比較的** 安全だと述べている。

個人的には、序章にもあるように、芸術家や、また、弁護士なども、とって替わられそうだなと考えたのだが、それも本当にはわからないので、上記のような問いに対して常に向き合ってキャリアを考えていく必要があるのかなと思う。
